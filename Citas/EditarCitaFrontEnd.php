...
<div class="container">
    <div class="row mt-4">
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
            ...
            <h3><i class="fa fa-search-plus"></i> Sistema para la edición de citas de servicio</h3>
            <div class="card border-top-0" style="width: 40rem;">
                <div class="card-header">
                    ...
                    <ul class="nav nav-tabs card-header-tabs" role="tablist">
                        ...
                        <li class="nav-item" role="tablist">
                            <a href="#nav-profile" id="profile" data-toggle="tab" role="tab" class="nav-link "><i class="fa fa-step-forward"></i> Paso 2</a>
                        </li>
                        <li class="nav-item" role="tablist">
                            <a href="#nav-contact" id="contact" data-toggle="tab" role="tab" class="nav-link	"><i class="fa fa-check-square"></i> Paso 3</a>
                        </li>
                    </ul>
                </div>
...
?>
                ...
                <div class="card-block tab-content">
                    ...
                    <div class="tab-pane fade active show" id="nav-home"  role="tabpanel" aria-labelledby="nav-home-tab">
                        <form action="EditarCitaBackEnd.php" id="frm_crear_cita" method="post" onsubmit="return validar();">
                            <input type="hidden" id="idCita" name="idCita" value="<?php echo $consulta->idCita ?>" required><br>

                            <fieldset class="form-group"><legend><i class="fa fa-calendar-plus-o"></i> Editar cita de servicio: </legend></fieldset>
                            <div>
                                <div class="form-group">
                                    ...
                                    ?>
                                    <select id="ciudad" name="taller" class="form-control" onchange="Taller()">
                                        <?php foreach($talleres as $taller):
                                            if($consulta->Taller_idTaller== $taller['idTaller']):
                                            ?>

                                            <option value="<?= $taller['idTaller']; ?>" selected><?= $taller['Taller_Nombre']; ?></option>
                                        <?php else:
                                        ?>
                                ...
                                <div class="form-group">
                                    ...
                                    ?>
                                    <select name="servicio" id="servicio" onchange="Servicio()" class="form-control">
                                        <?php foreach($servicios as $servicio):
                                            if($consulta->Servicio_idServicio== $servicio['idServicio']):
                                        ?>
                                            <option value="<?= $servicio['idServicio']; ?>"selected><?= $servicio['Servicio_Nombre']; ?></option>
                                        <?php else:
                                        ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="marca" name="marca" onchange="Marca()" class="form-control">
                                        <?php foreach($marcas as $marca):
                                        if($consulta->Modelo_idModelo== $marca['idMarca']): //conectarse a la tabla de marcas y jalar marca desde ahi
                                            ?>
                                            <option value="<?= $marca['idMarca']; ?>" selected><?= $marca['Marca_Nombre']; ?></option>
                                        <?php else:
                                        ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="modelo2" name="modelo" onchange="Modelo()" class="form-control">
                                        <?php foreach($modelos as $modelo):
                                        if($consulta->Modelo_idModelo== $modelo['idModelo']):
                                            ?>
                                            <option value="<?= $modelo['idModelo']; ?>" selected><?= $modelo['Modelo_Nombre']; ?></option>
                                        <?php else:
                                        ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="anio" name="ano" onchange="Año()" class="form-control">
                                        <?php foreach($anos as $ano):
                                            if($consulta->Ano_idAno== $ano['idAno']):
                                        ?>
                                            <option value="<?= $ano['idAno']; ?>"selected><?= $ano['Ano_Ano']; ?></option>
                                        <?php else:
                                            ?>
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <form action="" id="frm_crear_cita">
                            <fieldset class="form-group">
                                <legend><i class="fa fa-calendar-plus-o"></i> Editar cita de servicio: </legend>
                            </fieldset> <!---->
                            <div>
                                ...
                                <div class="form-group"><!----> <p>Seleccione una fecha para verificar las horas disponibles</p>
                                    ...
                                    <select id="fechascalendario" name="fecha" onchange="Fecha()" class="form-control">

                                        <?php foreach($fechas as $fecha):
                                        if($consulta->Fecha_idFecha== $fecha['idFecha']):
                                        ?>
                                            <option value="<?= $fecha['idFecha']; ?>"selected><?= $fecha['Fecha_fecha']; ?></option>
                                        <?php else:
                                        ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="hora" name="hora" onchange="Hora()" class="form-control">

                                        <?php foreach($horas as $hora):
                                        if($consulta->Hora_idHora== $hora['idHora']):
                                            ?>
                                            <option value="<?= $hora['idHora']; ?>" selected><?= $hora['Hora_hora']; ?></option>
                                        <?php  else:
                                        ?>
                    ...
                    <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                        ...
                        <div class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  ID="nombre" name="nombre_cliente"  class="form-control" value="<?php echo $consulta->Nombre_cliente ?>" data-toggle="tooltip">
                            </div>

                            <div class="form-group">
                                <label for="apellidos"><i class="fa fa-info"></i> Apellidos</label>
                                <input type="text" id="apellidos" name="apellido_cliente"  class="form-control" value="<?php echo $consulta->Apellido_cliente ?>" data-toggle="tooltip" >
                            </div>

                            <div class="form-group"><label for="telefono"><i class="fa fa-phone"></i> Telefono</label>
                                <input  type="phone" name="telefono" maxlength="13" id="telefono" class="form-control"  data-toggle="tooltip" value="<?php echo $consulta->Cliente_Telefono ?>">
                            </div>

                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="radio"  value="celular"   name="tipotel" id="optionsRadios1"  selected="selected" class="form-check-input"  data-toggle="tooltip"  > Celular
                                </label>
                            </div>

                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="radio" name="tipotel" id="optionsRadios2" value="casa" class="form-check-input"  data-toggle="tooltip" >Casa
                                </label>
                            </div>

                            <div class="form-group">
                                <label for="coreo"><i class="fa fa-envelope"></i> Correo electronico</label>
                                <input type="email" name="email" id="correo" class="form-control"  data-toggle="tooltip" value="<?php echo $consulta->Cliente_Correo ?>">
                            </div>

                            <div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input name="valet"  type="checkbox" class="form-check-input"  >
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea   name="comentario" id="comentario" rows="3" class="form-control" ><?php echo $consulta->Cliente_Comentarios ?></textarea>
                                </div>
                            </div>
                        </div>
